...
var LEVELS = [
  ...
  { name: 'TOWER TOPPLE', rows: ['..2...', '221...', '1100.0'], sol: [[4, 0]] },
  { name: 'TOPPLE MIRROR', rows: ['...2..', '...122', '0.0011'], sol: [[0, 0]] },
  { name: 'SKY CHAIN', rows: ['..3...', '332...', '221...', '1100.0'], sol: [[4, 0]] },
  { name: 'AVALANCHE', rows: ['...3..', '...233', '...122', '0.0011'], sol: [[0, 0]] },
  { name: 'PATIENCE', rows: ['33.3..', '22.2..', '11.1..', '00.0..'], sol: [[2, 0], [2, 0], [2, 0], [2, 0]] },
  { name: 'QUAKE', rows: ['..55.5', '..44.4', '..33.3'], sol: [[4, 0], [4, 0], [4, 0]] },
  { name: 'MEGA CHAIN', rows: ['..4...', '443...', '332...', '221...', '1100.0'], sol: [[4, 0]] },
  { name: 'LONG HAUL', rows: ['44.4..', '33.3..', '22.2..', '11.1..', '00.0..'], sol: [[2, 0], [2, 0], [2, 0], [2, 0], [2, 0]] },
  { name: 'GRAND CHAIN', rows: ['..5...', '554...', '443...', '332...', '221...', '1100.0'], sol: [[4, 0]] },
  { name: 'CHAOS THEORY', rows: ['2..3..', '22.33.'], sol: [[1, 0], [0, 1], [4, 0], [3, 1]] },
  { name: 'GRAND FINALE', rows: ['..0...', '005...', '554...', '443...', '332...', '221...', '1100.0'], sol: [[4, 0]] }
];
